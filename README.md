...
Kino media R2/S3 ga saqlanmaydi. Kino uchun Render env’da `TELEGRAM_API_ID`, `TELEGRAM_API_HASH`, `TELEGRAM_SESSION` va ixtiyoriy `KINO_STREAM_TOKEN_SECRET` sozlanadi; media Telegram’dan MTProto orqali oqim qilinadi, Bot API esa fallback sifatida ishlatiladi.
